...
_LABELS: dict[str, dict[str, str]] = {
    ...
    "immigration_court_hearing": {"en": "Immigration court hearing", "uk": "Слухання в імміграційному суді"},
    "ice_check_in": {"en": "ICE check-in", "uk": "Зустріч / check-in з ICE"},
    "immigration_detention": {"en": "Immigration detention", "uk": "Імміграційне затримання"},
    "released_from_detention": {"en": "Released from detention", "uk": "Звільнення із затримання"},
    "bond": {"en": "Bond", "uk": "Застава"},
    "supervision": {"en": "Supervision", "uk": "Нагляд імміграційної служби"},
    "removal_proceedings": {"en": "Removal proceedings", "uk": "Процедура видворення"},
    "removal_order": {"en": "Removal order", "uk": "Наказ про видворення"},
    "removed": {"en": "Removal completed", "uk": "Видворення виконано"},
    "status_terminated": {"en": "Status terminated", "uk": "Статус припинено"},
    "status_reinstated": {"en": "Status reinstated", "uk": "Статус поновлено"},
    "other_immigration_action": {"en": "Other immigration action", "uk": "Інша імміграційна дія"},
    "message_posted": {"en": "Telegram message posted", "uk": "Повідомлення опубліковано"},
    "action_date": {"en": "Action date", "uk": "Дата дії"},
    "issued": {"en": "Issued", "uk": "Видано"},
    "sent": {"en": "Sent", "uk": "Надіслано"},
    "received": {"en": "Received", "uk": "Отримано"},
    "occurred": {"en": "Occurred", "uk": "Відбулося"},
    "scheduled": {"en": "Scheduled", "uk": "Заплановано"},
    "in_status": {"en": "In status", "uk": "Мав(-ла) чинний статус"},
    "out_of_status": {"en": "Out of status", "uk": "Без чинного статусу"},
    "status_expired": {"en": "Status expired", "uk": "Статус закінчився"},
    "unclear": {"en": "Unclear", "uk": "Незрозуміло"},
    "immigration_court": {"en": "Immigration court matter", "uk": "Справа в імміграційному суді"},
    "arrival_after_program_cutoff": {"en": "Arrival after program cutoff", "uk": "Прибуття після граничної дати програми"},
    "missed_filing_deadline": {"en": "Missed filing deadline", "uk": "Пропущений строк подання"},
    "reported_ineligible_category": {"en": "Reported ineligible category", "uk": "Повідомлена невідповідна категорія"},
    "other_reported_concern": {"en": "Other reported eligibility concern", "uk": "Інше повідомлене питання відповідності"},
    "explicit_cause": {"en": "Explicitly stated cause", "uk": "Прямо вказана причина"},
    "reported_sequence": {"en": "Reported sequence only", "uk": "Лише повідомлена послідовність"},
...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "tab_immigration_actions": "Immigration actions",
        "tab_how_it_works": "How it works",
        "actions_intro": "Personal reports of immigration-agency, court, and enforcement actions found in community messages. General news and policy announcements are excluded.",
        "actions_disclaimer": "These are self-reported observations, not verified government records. A sequence does not prove that one event caused another, and small samples can be misleading.",
        "metric_action_reports": "Reports with an action",
        "metric_people_affected": "People affected",
        ...
        "actions_context_title": "Reported circumstances at the time",
        "actions_presence_title": "Status context",
        "actions_pending_title": "Pending immigration matters",
        "actions_eligibility_title": "Reported eligibility concerns",
        "actions_links_title": "Events reported before NTA or detention",
        "actions_no_data": "No matching personal reports are available for this data source yet.",
        "column_action": "Action",
        "column_month": "Month",
        "column_date_meaning": "Date meaning",
        "column_precursor": "Earlier event",
        "column_outcome": "Later action",
    ...
    "uk": {
        ...
        "tab_immigration_actions": "Імміграційні дії",
        ...
        "actions_intro": "Особисті повідомлення про дії імміграційних органів, суду та правоохоронних органів, знайдені в повідомленнях спільноти. Загальні новини та зміни політики не враховуються.",
        "actions_disclaimer": "Це повідомлення користувачів, а не перевірені державні дані. Послідовність подій не доводить, що одна подія спричинила іншу, а мала вибірка може вводити в оману.",
        "metric_action_reports": "Повідомлень із діями",
        "metric_people_affected": "Зачеплено людей",
        ...
        "actions_context_title": "Повідомлені обставини на той момент",
        "actions_presence_title": "Інформація про статус",
        "actions_pending_title": "Справи, що очікували рішення",
        "actions_eligibility_title": "Повідомлені питання відповідності вимогам",
        "actions_links_title": "Події, повідомлені перед NTA або затриманням",
        "actions_no_data": "Для цього джерела даних поки немає відповідних особистих повідомлень.",
        "column_action": "Дія",
        "column_month": "Місяць",
        "column_date_meaning": "Значення дати",
        "column_precursor": "Попередня подія",
        "column_outcome": "Наступна дія",
        "column_relationship": "Зв’язок",
        "tps_decisions_intro": (
